# AUTH-02 — Password Spray Pattern (Low and Slow Across Users)
...
## What this detects
Detects a password-spray style pattern: many distinct users receiving a small number of failures from the same source over a time window.
