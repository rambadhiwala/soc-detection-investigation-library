# AUTH-01 — Brute Force Burst (Multiple Failures)
...
## What this detects
Detects a burst of failed authentication attempts against a single user or across many users from the same source in a short time window.
