# DLP-01 — Sensitive Data Sent Externally via Email (DLP Match)

**Category:** dlp  
**Suggested Severity:** HIGH  
**MITRE ATT&CK:** T1041 Exfiltration (context)

## What this detects
Detects DLP policy matches where sensitive data is attempted to be sent to external recipients.
...
## References (general)
- MITRE ATT&CK technique: **T1041 Exfiltration (context)**
