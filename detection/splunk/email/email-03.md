# EMAIL-03 — Mailbox Forwarding Rule Created

**Category:** email  
**Suggested Severity:** HIGH  
**MITRE ATT&CK:** T1114 Email Collection (context)

## What this detects
Detects creation of inbox/forwarding rules that send mail to external recipients (common in business email compromise).
...
## References (general)
- MITRE ATT&CK technique: **T1114 Email Collection (context)**
