# AUTH-03 — Impossible Travel / Geo Anomaly
...
## What this detects
Detects logins from geographically distant locations in an implausibly short time, suggesting compromised credentials or VPN/proxy misuse.
