# EMAIL-01 — Suspicious External Email With Link (Lookalike Domain)
...
## What this detects
Detects external emails containing URLs where the sender domain resembles the organization’s brand or uses newly registered domains.
