# DLP-02 — Sensitive Files Copied to Removable Media (DLP)

**Category:** dlp  
**Suggested Severity:** HIGH  
**MITRE ATT&CK:** T1052 Exfiltration Over Physical Media

## What this detects
Detects DLP events associated with copying sensitive files to removable media.
...
## References (general)
- MITRE ATT&CK technique: **T1052 Exfiltration Over Physical Media**
